...
<body>
      ...
      <div class="container">
        ...
        <div class="slider-container has-scrollbar">
          ...
          <div class="slider-item">
            ...
            <img src="./assets/images/banner-4.jpg" alt="women's latest fashion sale" class="banner-img">

            <div class="banner-content">

              <p class="banner-subtitle">Trending item</p>

              <h2 class="banner-title"> latest Shoes sale</h2>
          ...
          <div class="slider-item">
            ...
            <img src="./assets/images/banner-5.jpg" alt="modern sunglasses" class="banner-img">

            <div class="banner-content">

              <p class="banner-subtitle">Trending accessories</p>

              <h2 class="banner-title">Modern shoes</h2>

              <p class="banner-text">
                starting at &dollar; <b>60</b>.00
              </p>
          ...
          <div class="slider-item">
            ...
            <img src="./assets/images/banner-6.jpg" alt="new fashion summer sale" class="banner-img">

            <div class="banner-content">

              <p class="banner-subtitle">Sale Offer</p>

              <h2 class="banner-title">New Sports shoes sale</h2>

              <p class="banner-text">
                starting at &dollar; <b>50</b>.80
              </p>
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    ...
                    <a href="/clothes"><p class="menu-title">Clothes</p></a>
                  </div>
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    ...
                    <a href="/footwear"> <p class="menu-title">Footwear</p></a>
                  </div>
              ...
              <div class="showcase-wrapper  has-scrollbar">
                ...
                <div class="showcase-container">
                  ...
                  <div class="showcase">
                    ...
                    <div class="showcase-content">
                     ...
                     <a class="button"  href="/product.jsp?pname=Running" >Buy Now</a>   
                  </div>
                  ...
                  <div class="showcase">
                    ...
                    <a class="button"  href="/product.jsp?pname=Trekking" >Buy Now</a>  
                  ...
                  <div class="showcase">
                    ...
                    <a class="button"  href="/product.jsp?pname=Womens Party Wear Shoes" >Buy Now</a>   
                  </div>
                  ...
                  <div class="showcase">
                    ...
                    <a class="button"  href="/product.jsp?pname=Sports" >Buy Now</a>  
                  </div>
                ...
                <div class="showcase-container">
                  ...
                  <div class="showcase">
                    ...
                    <a class="button"  href="/product.jsp?pname=Air Trekking Shoes - white" >Buy Now</a>   
                  </div>
                  ...
                  <div class="showcase">
                    ...
                    <a class="button"  href="/product.jsp?pname=Boot With Suede Detail" >Buy Now</a>   
                  </div>
                  ...
                  <div class="showcase">
                    ...
                    <a class="button"  href="/product.jsp?pname=Leather-shoes" >Buy Now</a>   
                  </div>
                  ...
                  <div class="showcase">
                    ...
                    <div class="showcase-content">
                     ...
                     <a class="button"  href="/product.jsp?pname=Casual-shoes">Buy Now</a>    
                  </div>
 ...
 <style>
    .button { padding: 10px 20px; font-size: 16px; cursor: pointer; border: 1px solid #ccc; background-color: #4d4446; border-radius: 5px; }
.button:hover { background-color: #f74905; }
